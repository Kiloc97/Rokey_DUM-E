...
YOLO_OVER_MODEL_FILENAME = "over.pt"
YOLO_OVER_MODEL_PATH = os.path.join(PACKAGE_PATH, "resource", YOLO_OVER_MODEL_FILENAME)
...
class YoloModel:
    ...
    def switch_to_over_model(self):
        self.load_model(YOLO_OVER_MODEL_PATH)
