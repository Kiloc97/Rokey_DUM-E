...
class RobotMotion():
    def __init__(self, node):
        ...
        self.get_position_client = node.create_client(
        ...
        self.change_model_client = node.create_client(
            SetBool, "/change_yolo_model"
        )
        
        self.get_keyword_client = node.create_client(Command, "get_keyword")
        self.get_keyword_request = Command.Request()

        self.move_stop_client = node.create_client(
        ...
        self._detection_client = node.create_client(SrvDepthPosition, 'service_detection')
