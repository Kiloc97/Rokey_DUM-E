...
pos_dic = {'hammer': [[303.51, 605.03, 196, 57.86, 179.86, 59.19]],
           'monkey': [[42.78, 625.21, 196, 90.63, -179.38, 89.04]],
           '6wrench': [[102.47, 419.22, 196, 77.99, -179.36, 77.75]],
           'screwdriver': [[184.11, 570.52, 196, 178.7, 179.7, 177.24]],
           'pipewrench': [[-10.16, 476.35, 196, 88.88, -179.35, 88.43]],
           'wrench': [[210, 448.77, 196, 82, -179.52, 80.82]],
           'knief': [[349.06, 427.79, 196, 67.79, -179.51, 67.53]],
           'voltcup': [[322.26, 652.55, 235.06, 81.5, 157.18, 87.03]],
           'nutcup': [[140.43, 687.5, 248.12, 100.55, 166.25, 107]]}
...
class RobotController(Node):
    ...
    def robot_control(self):
        ...
        if task == 'bring':
            if object:
                ...
                self.get_logger().warn("No object for bring command")
        elif task == 'clear':
            self.clear()
        elif task == 'hold':
            self.hold()
    ...
    def pick(self, target_pos, tool, z):
        ...
        target_pos[2] = z
        target_pos[3:] = [90.06, 115.37, 90.00]
