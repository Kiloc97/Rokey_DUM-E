...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'wakeup_key = voice_processing.wakeup_key:main',
            'teleop_key = voice_processing.teleop_key:main',
            'threading_test = voice_processing.threading_test:main',
            'test_image = voice_processing.test_image:main',
        ],
    },
)